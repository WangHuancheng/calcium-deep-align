...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        test_dataloader = DataLoader(dataset,batch_size=32,num_workers=20)
        ...
        train_wrapped = torch.load('dataset1/test_wrapped.pt')
        train_wrapped /=2455
        dataset=torch.utils.data.TensorDataset(train_wrapped,train_gd)
        train_dataloader = DataLoader(dataset,batch_size=32,num_workers=20)
